...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_gallery3, container, false);
        ...
        buttonGetPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //fliter to only show result that can be "opened"
                intent.addCategory(Intent.CATEGORY_OPENABLE);

                //filter to show only images, using the image MIME data
